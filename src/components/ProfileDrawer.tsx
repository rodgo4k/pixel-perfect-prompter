...
const ProfileDrawer = ({ open, onClose }: ProfileDrawerProps) => {
  ...
  return (
    <div
      className="absolute top-full right-0 mt-2 w-[268px] bg-card border border-border shadow-2xl rounded-lg z-50 flex flex-col overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200"
