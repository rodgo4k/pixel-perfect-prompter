    ...
    <div className="fixed inset-0 z-50" onClick={onClose}>
      ...
      >
        ...
        <div className="flex-1 flex flex-col gap-1 p-4">
          ...
          {/* Discord */}
          <button className="flex items-center justify-center gap-2 w-full py-3 mt-2 rounded-lg bg-[hsl(235,86%,65%)] text-white text-sm font-semibold hover:bg-[hsl(235,86%,55%)] transition-colors">
