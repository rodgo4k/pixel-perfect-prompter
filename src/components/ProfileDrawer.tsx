import { X, MessageSquare, Palette, Moon, Sun, Globe, LogOut } from "lucide-react";
    ...
    <div className="fixed inset-0 z-50" onClick={onClose}>
      ...
      >
        ...
        <div className="flex-1 flex flex-col gap-1 p-4">
          {/* Linguagem */}
          <button className="flex items-center gap-3 w-full px-4 py-3 text-sm text-foreground hover:bg-secondary/50 rounded-lg transition-colors">
          ...
          {/* Discord */}
          <button className="flex items-center justify-center gap-2 w-full py-3 mt-2 rounded-lg bg-[hsl(235,86%,65%)] text-primary-foreground text-sm font-semibold hover:bg-[hsl(235,86%,55%)] transition-colors">
          ...
          {user ? (
            ...
            <button
              onClick={handleLogin}
              className="w-full py-3 mt-2 rounded-lg bg-primary text-primary-foreground text-sm font-semibold hover:bg-primary/90 transition-colors"
            >
              Login
            </button>
          )}
